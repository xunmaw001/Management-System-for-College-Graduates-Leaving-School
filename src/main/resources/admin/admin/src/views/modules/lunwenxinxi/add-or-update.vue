    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="完成情况" prop="wanchengqingkuang">
          <el-select :disabled="ro.wanchengqingkuang" v-model="ruleForm.wanchengqingkuang" placeholder="请选择完成情况">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="不及格原因" prop="bujigeyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="不及格原因"
                  v-model="ruleForm.bujigeyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bujigeyuanyin" label="不及格原因" prop="bujigeyuanyin">
                    <span>{{ruleForm.bujigeyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wanchengqingkuang = true;
          ...
          if(o=='bujigeyuanyin'){
            this.ruleForm.bujigeyuanyin = obj[o];
	    this.ro.bujigeyuanyin = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.zhigongxingming!=''&&json.zhigongxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.wanchengqingkuangOptions = "及格,不及格".split(',')
