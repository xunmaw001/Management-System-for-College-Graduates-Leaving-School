...
public class LixiaoshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,LixiaoshenqingEntity lixiaoshenqing,
		...
		if(tableName.equals("jiaowuchu")) {
			lixiaoshenqing.setZhigongzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		if(tableName.equals("jiaowuchu")) {
            ew.eq("zhigongzhanghao", (String)request.getSession().getAttribute("username"));
		}
